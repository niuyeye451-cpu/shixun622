...
医生在患者症状和查体的基础上作出诊断。有时需要进行 磁共振成像 (MRI) 检查。
...
一旦疼痛开始缓解，患者应轻轻拉伸腿后肌群。疼痛完全缓解时，股四头肌和股后肌群逐渐恢复力量。在受伤肌肉力量和活动范围恢复正常前，患者不要奔跑或跳跃。几天或几周内开始恢复，但是严重的股后肌损伤经常需数月才能完全康复。
...
a. 开始时使用最小阻力，然后根据耐受情况增加重量。也可使用阻力带。


b. 重点关注复位（放下）阶段，将膝关节放下并伸展至起始位置计数为 4，膝关节屈曲计数为 2。
