...
**
浏览专业版
[小知识](https://www.msdmanuals.cn/home/quick-facts-injuries-and-poisoning/fractures/broken-collarbone)
...
大部分锁骨骨折可通过用吊带固定 4~6 周来治疗（见图 固定关节的常用方法 ）。可能只需要一个吊带就可以了。
